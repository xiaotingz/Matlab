...
grain_diameter_raw = roundn(h5read('/Volumes/RESEARCH/Oct.26 MinNeigh=4/Oct.26 Austenite/processing/Oct26_A_ForCurv.dream3d','/VoxelDataContainer/FIELD_DATA/EquivalentDiameters'),-5);
...
centroids = roundn(h5read('/Volumes/RESEARCH/Grain Curvature/Jun.24 Ferrite/Jun.24 ForCurv_centroid.dream3d','/VoxelDataContainer/FIELD_DATA/Centroids'),-5).';
grain_diameter_raw = roundn(h5read('/Volumes/RESEARCH/Grain Curvature/Jul.20 Austenite/processing/Jul20_ForCurv_centroid.dream3d','/VoxelDataContainer/FIELD_DATA/EquivalentDiameters'),-5);
