...
%         angle_diff_all_1 = [angle_diff_all_1; ang_diff_tmp1];
%         angle_diff_all_2 = [angle_diff_all_2; ang_diff_tmp2];
...
print('all plane normal variants to {111} family, min angles, all planes','-dpng','-r300')
