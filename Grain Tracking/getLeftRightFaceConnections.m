function nn_faces = getLeftRightFaceConnections(tracked_faces, tls, file, obj_faces)
% ##########################################################################
% * Input
%     - unique_faces = [n1,2]  
