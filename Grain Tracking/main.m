...
FAvgCurv_diff = FItgCurvs_An5(faceCorresp(:,2),2)./FItgCurvs_An5(faceCorresp(:,2),1) - FItgCurvs_An4(faceCorresp(:,1),2)./FItgCurvs_An4(faceCorresp(:,1),1);
clear diff_tmp
...
ylim_bin = [-1e4, 1e4];
subplot(3,2,1)
plotScatter(FItgCurvs_An4(faceCorresp(:,1),1), FItgCurvs_An4(faceCorresp(:,1),2), 'Face Area in An4, \mum^{2}', 'Integral |Face Curvature| in An4, \mum');
title(['ylim of binning = [', num2str(ylim_bin), '], An4'])
subplot(3,2,3)
plotBinData(FItgCurvs_An4(faceCorresp(:,1),1), FItgCurvs_An4(faceCorresp(:,1),2), [0, 10000], ylim_bin, 100, 'Face Area in An4, \mum^{2}', 'Integral |Face Curvature| in An4, \mum', true, false) 
subplot(3,2,5)
plotBinData(FItgCurvs_An4(faceCorresp(:,1),1), FItgCurvs_An4(faceCorresp(:,1),2), [0, 1000], ylim_bin, 50, 'Face Area in An4, \mum^{2}', 'Integral |Face Curvature| in An4, \mum', true, true)
subplot(3,2,2)
plotScatter(FItgCurvs_An5(faceCorresp(:,2),1), FItgCurvs_An5(faceCorresp(:,2),2), 'Face Area in An5, \mum^{2}', 'Integral |Face Curvature| in An5, \mum');
title(['ylim of binning = [', num2str(ylim_bin), '], An5'])
subplot(3,2,4)
plotBinData(FItgCurvs_An5(faceCorresp(:,2),1), FItgCurvs_An5(faceCorresp(:,2),2), [0, 10000], ylim_bin, 100, 'Face Area in An5, \mum^{2}', 'Integral |Face Curvature| in An5, \mum', true, false)
subplot(3,2,6)
plotBinData(FItgCurvs_An5(faceCorresp(:,2),1), FItgCurvs_An5(faceCorresp(:,2),2), [0, 1000], ylim_bin, 50, 'Face Area in An5, \mum^{2}', 'Integral |Face Curvature| in An5, \mum', true, true)
...
subplot(3,1,2)
plotBinData(FItgCurv_diff, FA_diff, [-500, 500], ylim_bin, 5, 'Integral |Face Curvature| Difference, \mum', 'Face Area Difference, \mum^{2}', true, true )
subplot(3,1,3)
plotBinData(FItgCurv_diff, FA_diff, [-100, 100], ylim_bin, 5, 'Integral |Face Curvature| Difference, \mum', 'Face Area Difference, \mum^{2}', true, true)
...
subplot(2,2,4)
plotBinData(FAvgCurv_diff, FA_diff, [-0.5, 0.5], ylim_bin, 0.01, 'Average Face Curvature Difference, \mum^{-1}', 'Face Area Difference, \mum^{2}', true, false)
% ylim([-1000, 1000])
...
ylim_bin = [-1e4, 1e4];
subplot(2,2,1)
plotScatter(FItgCurvs_An4(faceCorresp(:,1),2), FItgCurv_diff, 'Integral |Face Curvature| in An4, \mum', 'Integral |Face Curvature| Difference, \mum');
title(['ylim of binning = [', num2str(ylim_bin), ']'])
subplot(2,2,2)
plotBinData(FItgCurvs_An4(faceCorresp(:,1),2), FItgCurv_diff, [0, 300], ylim_bin, 5, 'Integral |Face Curvature| in An4, \mum', 'Integral |Face Curvature| Difference, \mum', false)
subplot(2,2,3)
plotScatter(FItgCurvs_An5(faceCorresp(:,2),2), FItgCurv_diff, 'Integral |Face Curvature| in An5, \mum', 'Integral |Face Curvature| Difference, \mum');
title(['ylim of binning = [', num2str(ylim_bin), ']'])
subplot(2,2,4)
plotBinData(FItgCurvs_An5(faceCorresp(:,2),2), FItgCurv_diff, [0, 300], ylim_bin, 5, 'Integral |Face Curvature| in An5, \mum', 'Integral |Face Curvature| Difference, \mum', false)
...
title(['ylim of binning = [', num2str(ylim_bin), ']'])
subplot(2,2,2)
plotBinData(abs(FItgCurv_diff), FCentrs_diff, [0, 500], ylim_bin, 5, 'abs(Integral |Face Curvature| Difference), \mum', 'norm(Face Centorid Difference), \mum',true,true)
subplot(2,2,3)
plotBinData(abs(FItgCurv_diff), FCentrs_diff, [0, 200], ylim_bin, 2, 'abs(Integral |Face Curvature| Difference), \mum', 'norm(Face Centorid Difference), \mum',true, true)
subplot(2,2,4)
plotBinData(abs(FItgCurv_diff), FCentrs_diff, [0, 200], ylim_bin, 2, 'abs(Integral |Face Curvature| Difference), \mum', 'norm(Face Centorid Difference), \mum', true, false)
% ylim([450,750])
