function plotMedianPlanes(features, face_tri_node_1, face_tri_node_2, x_to_y, median_plane_info)
% ############################################################################
% NOTES
...
%         [cluster_id, normal, bias], for normal and bias in each row are row are for each cluster
% ############################################################################
% ------------------ load data for debug --------------------
...
%     else
        ...
        normal = median_plane_info(median_plane_info(:,1)==i, 2:4);
        bias = median_plane_info(median_plane_info(:,1)==i, 5);
