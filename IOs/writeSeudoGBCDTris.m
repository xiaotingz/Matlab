...
fa = zeros(size(data, 1), 1) * NaN;
fa_diff = zeros(size(data, 1), 1) * NaN;
fitg_curv = zeros(size(data, 1), 1) * NaN;
fitg_curv_diff = zeros(size(data, 1), 1) * NaN;
...
write(file_an4, '/DataContainers/TriangleDataContainer/FaceData/DAResidentFace', w_fa_diff);
write(file_an4, '/DataContainers/TriangleDataContainer/FaceData/DMsfResidentFace', w_fa_absdiff);
write(file_an4, '/DataContainers/TriangleDataContainer/FaceData/absDAResidentFace', w_fitg_curv_diff);
write(file_an4, '/DataContainers/TriangleDataContainer/FaceData/absDMsfResidentFace', w_figt_curv_absdiff);
